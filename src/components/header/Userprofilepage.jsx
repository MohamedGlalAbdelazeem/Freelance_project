          ...
          <div className="mb-2 pt-2">
            <div>
              <div className="flex justify-center items-center">
                <img
                  src={userPhoto}
                  className="border-double border-4 border-sky-500 w-36 rounded-full h-36 mb-8"
      ...
      <div className="items-center justify-center p-12">
        <div className="rounded-3xl mx-auto w-full max-w-[750px] bg-gray-700 text-white p-10">
          <form>
            ...
            <div>
              <button className="hover:shadow-form rounded-md bg-success hover:bg-success/90 py-3 px-8 text-base font-semibold text-white outline-none">
                تغيير
              </button>
            </div>
          </form>
